...
namespace GaragemGestao.Controllers
{
    public class MechanicsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,StartDate,EndDate,IsActive")] Mechanic mechanic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,StartDate,EndDate,IsActive")] Mechanic mechanic)
        {
            if (id != mechanic.Id)
            {
                return NotFound();
